                                     ...
                                     Gain gain)
{
  ...
  double thrust = mass_ * (g_ + des.a(2) + gain.KAngY * (des.v(2) - odom.v(2)) + 2 * gain.Kp2 * (des.p(2) - odom.p(2)));
  ...
  double phi_c = (ddot_p_xc * sin(current_pos(2)) - ddot_p_yc * cos(current_pos(2))) / g_;
  double theta_c = (ddot_p_xc * cos(current_pos(2)) + ddot_p_yc * sin(current_pos(2))) / g_;
  //double psi_c;
