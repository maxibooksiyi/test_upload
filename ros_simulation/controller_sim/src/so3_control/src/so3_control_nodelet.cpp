...
public:
  SO3ControlNodelet()
      : position_cmd_updated_(false), position_cmd_init_(false), current_yaw_(0), enable_motors_(true), // FIXME
...
void SO3ControlNodelet::imu_callback(const sensor_msgs::ImuConstPtr &imu)
{
  imu_data.feed(imu);
}
